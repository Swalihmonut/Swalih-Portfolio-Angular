...
@Component({
  selector: 'app-pricing14',
  templateUrl: 'pricing14.component.html',
  styleUrls: ['pricing14.component.css'],
})
export class Pricing14 {
  @ContentChild('plan2Action')
  plan2Action: TemplateRef<any>
  @ContentChild('plan3Yearly1')
  plan3Yearly1: TemplateRef<any>
  @ContentChild('plan2Action1')
  plan2Action1: TemplateRef<any>
  @ContentChild('plan1Action1')
  plan1Action1: TemplateRef<any>
  @ContentChild('plan2Feature41')
  plan2Feature41: TemplateRef<any>
  @ContentChild('plan3Price1')
  plan3Price1: TemplateRef<any>
  @ContentChild('plan3Price')
  plan3Price: TemplateRef<any>
  @ContentChild('plan3Feature1')
  plan3Feature1: TemplateRef<any>
  @ContentChild('content2')
  content2: TemplateRef<any>
  @ContentChild('plan3Feature2')
  plan3Feature2: TemplateRef<any>
  @ContentChild('plan2Feature21')
  plan2Feature21: TemplateRef<any>
  @ContentChild('plan2Yearly1')
  plan2Yearly1: TemplateRef<any>
  @ContentChild('plan2Price1')
  plan2Price1: TemplateRef<any>
  @ContentChild('plan3')
  plan3: TemplateRef<any>
  @ContentChild('plan1Price')
  plan1Price: TemplateRef<any>
  @ContentChild('plan3Yearly')
  plan3Yearly: TemplateRef<any>
  ...
  @ContentChild('plan3Action1')
  plan3Action1: TemplateRef<any>
  ...
  @ContentChild('plan2Feature4')
  plan2Feature4: TemplateRef<any>
  @ContentChild('plan3Feature11')
  plan3Feature11: TemplateRef<any>
  @ContentChild('plan1Feature11')
  plan1Feature11: TemplateRef<any>
  @ContentChild('plan3Feature3')
  plan3Feature3: TemplateRef<any>
  @ContentChild('plan3Feature21')
  plan3Feature21: TemplateRef<any>
  @ContentChild('plan21')
  plan21: TemplateRef<any>
  @ContentChild('plan31')
  plan31: TemplateRef<any>
  ...
  @ContentChild('plan3Action')
  plan3Action: TemplateRef<any>
  @ContentChild('plan3Feature31')
  plan3Feature31: TemplateRef<any>
  @ContentChild('plan3Feature4')
  plan3Feature4: TemplateRef<any>
  @ContentChild('plan1')
  plan1: TemplateRef<any>
  @ContentChild('plan3Feature5')
  plan3Feature5: TemplateRef<any>
  ...
  @ContentChild('plan3Feature41')
  plan3Feature41: TemplateRef<any>
  @ContentChild('plan2')
  ...
  @ContentChild('plan3Feature51')
  plan3Feature51: TemplateRef<any>
